...
public class myClass {
     ...
     */
    public static boolean saveUserInfo(Context context,String username,String pas,String net,String ip){
        /**
         * SharedPreferences将用户的数据存储到该包下的shared_prefs/config.xml文件中，
         * 并且设置该文件的读取方式为私有，即只有该软件自身可以访问该文件
         */

        if(username.equals("") || pas.equals("") || net.equals("") || ip.equals("")) return false;
